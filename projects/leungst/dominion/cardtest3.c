...
int main(){
	...
	// 	state->playedCardCount + playedCount);
	...
	printf("\n\n");
	printf("Testing if other player's score was affected.....\n");
	printf("-----------------------------------------------------\n");

	printf("- Before target card, Score:\t%d|\t Now: %d\n", opponentScore,  scoreFor(1, testState));
